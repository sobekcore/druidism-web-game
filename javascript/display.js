...
const Display = function(canvas)
{
  ...
  this.drawMap = function(image, image_columns, map, map_columns, tile_size)
  {
    for(let index = map.length - 1; index > -1; --index)
    {
      ...
      this.buffer.drawImage(
        image, source_x, source_y, tile_size, tile_size, destination_x, destination_y, tile_size, tile_size
      );
    }
  };
  ...
  {
    this.buffer.drawImage(
      image, source_x, source_y, width, height,
...
Display.prototype =
{
  ...
  render:function()
  {
    this.context.drawImage(
      this.buffer.canvas, 0, 0, this.buffer.canvas.width, this.buffer.canvas.height,
